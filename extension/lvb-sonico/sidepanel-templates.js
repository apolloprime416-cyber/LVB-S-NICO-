...
function spTemplateLicenseGate() {
  return '<div class="sp-license-gate">' +
    '<img class="sp-login-logo" src="/icons/icon128.png" alt="' + ((window.tsBrandName && window.tsBrandName()) || 'LVB Sônico') + '">' +
    '<p class="sp-gate-title">Bem vindo a <span data-ts-brand="name">' + ((window.tsBrandName && window.tsBrandName()) || 'LVB Sônico') + '</span></p>' +
    '<p class="sp-gate-desc">Insira sua chave de licença para desbloquear.</p>' +
    '<input class="sp-input" id="sp-license-input" placeholder="LVB-XXXX-XXXX-XXXX" spellcheck="false">' +
